...
class SplitAdapter1(private val c: Context, var onCheckBoxclick: OnCheckBoxclick) :
    RecyclerView.Adapter<SplitAdapter1.BeatsViewHolder>() {
    private var userlist: List<UserData1>? = null
    private var userId: Int = 0
    private var promolink : String = "test";
    private  var userId1: MutableList<String> = mutableListOf()

    fun setList(userlist1: List<UserData1>,) {
